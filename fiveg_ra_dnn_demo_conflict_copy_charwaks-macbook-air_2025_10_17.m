...
%% Create outputs folder (with error handling)
outDir = 'outputs';
...
%% Simulation Parameters (ADJUSTED FOR REAL DATA)
...
% These weights are fine-tuned to ensure critical applications (like Emergency Service) are allocated resources.
% Weights are based on importance/rarity: [4 6 8 7 5 4 8 5 7]
